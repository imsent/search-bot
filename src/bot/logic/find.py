...
async def find_handler(message: types.Message):
    ...
    await msg.edit_text("По вашему запросы ничего не найдено. Пожалуйста, проверьте правильность введенной вами информации. Если все введено верно, то попробуйте написать запрос по-другому." if len(answer) == 0 else answer[0])